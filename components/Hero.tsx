  ...
  return (
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-5xl text-center text-2xl font-bold text-foreground md:text-4xl lg:text-5xl xl:text-6xl">
        ...
        <motion.h2
          ...
          className="relative z-10 mx-auto max-w-3xl text-center text-xl font-semibold text-primary md:text-2xl lg:text-3xl"
        >
